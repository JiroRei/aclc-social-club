...
export default function Home() {
  ...
  return (
    <main className="relative">
      <Header />
      <Image src="/ACLC_SC_Logo_A3.png" alt="logo_aclc" width={500} height={200} className="-z-10 absolute bottom-10 right-0 p-2 opacity-45"/>
      <div className="flex flex-col justify-center items-start gap-10 p-2 mt-5">
